...
void main()
{
    ...
    mat2 cov2D = mat2(gs_in[0].geom_cov2.xy, gs_in[0].geom_cov2.zw);
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        gl_Position = gl_Position + vec4(offset.x, offset.y, 0.0, 0.0);
        frag_color = gs_in[0].geom_color;
        frag_cov2inv = cov2Dinv4;
        frag_p = gs_in[0].geom_p;
