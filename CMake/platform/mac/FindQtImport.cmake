...
if(NOT NIMAGNA_BUILD_TYPE)
    message(WARNING "Build type not defined!")
endif()
if(NIMAGNA_BUILD_TYPE STREQUAL "GitHub")
    if(DEFINED ENV{QT_ROOT_DIR})
        set(QT_BASE_DIR $ENV{QT_ROOT_DIR})
    else()
        message(FATAL_ERROR "QT_ROOT_DIR not defined!")
    endif()
else()
